...
<div id="joinWrap">
    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <input type="text" id="univ_name" class="form-control" placeholder="대학명" aria-label="Recipient's username"
    ...
    <div class="form-group">
        <label>학번</label>
        <input type="text" class="form-control" id="inputAddress2" placeholder="학번">
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
            <label>비밀번호</label>
            <input type="email" class="form-control" id="inputEmail4" placeholder="비밀번호">
        </div>
        <div class="form-group col-md-6">
            <label>비밀번호 확인</label>
            <input type="password" class="form-control" id="inputPassword4" placeholder="비밀번호 확인">
        </div>
    </div>
