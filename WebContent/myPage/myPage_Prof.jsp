        ...
        <tr>
            ...
            <td id="navSub">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#aaa">상담완료</a>
                    </li>
                </ul>
                        ...
                        <div id="board">
                            <table class="boardListWrap">
                                ...
                                <tr id="boardList">
                                    ...
                                    <td>
                                        <button id="acceptBtn">수락하기</button>
                                    </td>
                                    <td>
                                        <button id="rejectBtn">거절하기</button>
                                    </td>
                                </tr>
                                <tr id="boardList">
                                    <td>000교수님</td>
                        ...
                        <div id="board">
                            <table class="boardListWrap">
                                ...
                                <tr id="boardList">
                                    ...
                                    <td>2021-07-10 오전 9:00</td>
                                    <td>
                                        <button id="incompleteBtn">미완료</button>
                                    </td>
                                    <td>
                                        <button id="editingBtn">수정하기</button>
                                    </td>
                        ...
                        <div id="board">
                            <table class="boardListWrap">
                                ...
                                <tr id="boardList">
                                    ...
                                    <td>2021-07-10 오전 9:00</td>
                                    <td>
                                        <button id="recordBtn">상담기록</button>
                                    </td>
                                </tr>
                                <tr id="boardList">
                                    <td>000교수님</td>
